...
const MemeScannerPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5]">
      {/* Page Header */}
      <header className="bg-[#F5F5F5] border-b border-[#708090]/10 p-6">
        <div className="max-w-[1600px] mx-auto">
          <h1 className="text-2xl font-bold text-[#4A4A4A]">Meme Scanner</h1>
      ...
      {/* Footer */}
      <footer className="bg-[#F5F5F5] border-t border-[#708090]/10 p-4">
